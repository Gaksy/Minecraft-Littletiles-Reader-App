...
STRINGS = {
    ...
    '已是最新版本（%s）': 'À jour (%s)',
    '更新内容：\n%s': 'Nouveautés :\n%s',
    '只检查稳定版；测试版请到下载页自己取。': 'Seules les versions stables sont vérifiées ; les bêtas sont sur la page de téléchargement.',
    '服务器上目前只有测试版；客户端只检查稳定版更新。': 'Seule une bêta est publiée pour cette plateforme ; le client ne vérifie que les versions stables.',
